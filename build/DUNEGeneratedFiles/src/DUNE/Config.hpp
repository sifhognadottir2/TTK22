...
//! DUNE's copyright.
#define DUNE_COPYRIGHT "Copyright (C) 2007-2021 - Universidade do Porto - LSTS"
//! DUNE's contact.
#define DUNE_CONTACT "DUNE <dune@lsts.pt>"
//! DUNE's build type.
#define DUNE_BUILD_TYPE "Release"
//! DUNE's system name.
#define DUNE_SYSTEM_NAME "x86-64bit-linux-glibc-gcc93"
//! DUNE's source path.
#define DUNE_PATH_SRC "/home/sif/lststools/dune/source"
//! DUNE's build path.
#define DUNE_PATH_BUILD "/home/sif/lststools/dune/build"
